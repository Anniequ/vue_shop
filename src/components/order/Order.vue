<template>
  <div>
    ...
    <!-- 修改地址的对话框 -->
    <el-dialog title="修改地址" :visible.sync="editAddDialogVisible" width="50%" @close="adsDialogClosed">
      <!-- 添加分类的表单 -->
    ...
    <!-- 显示物流进度的对话框 -->
    <el-dialog title="物流进度" :visible.sync="proDialogVisible" width="50%" @close="proDialogClosed">
      <el-timeline>
        <el-timeline-item v-for="(proInfo, index) in proInfo" :key="index" :timestamp="proInfo.time">
          {{ proInfo.context }}
        </el-timeline-item>
      </el-timeline>
    </el-dialog>
